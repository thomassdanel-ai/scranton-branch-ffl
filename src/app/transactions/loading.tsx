  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="h-4 w-80 bg-bg-tertiary rounded mt-2 animate-pulse" />
      </div>
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <div className="h-4 w-4 bg-accent-green/20 rounded animate-pulse" />
            <div className="h-4 w-36 bg-bg-tertiary rounded animate-pulse" />
          </div>
          <div className="flex items-center gap-2">
            <div className="h-4 w-4 bg-accent-red/20 rounded animate-pulse" />

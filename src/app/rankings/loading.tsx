  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="h-4 w-96 bg-bg-tertiary rounded mt-2 animate-pulse" />
      </div>

      {/* Formula box skeleton */}
      <div className="glass-card p-4">
        <div className="h-3 w-24 bg-bg-tertiary rounded animate-pulse mb-2" />
        <div className="h-3 w-full bg-bg-tertiary rounded animate-pulse" />
        <div className="h-3 w-3/4 bg-bg-tertiary rounded animate-pulse mt-1" />
      </div>
      ...
      <div className="glass-card overflow-hidden">
        ...
        <div className="flex items-center gap-4 p-4 border-b border-white/5">
          ...
          <div className="h-4 w-16 bg-bg-tertiary rounded animate-pulse ml-auto" />
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          ...
          >
            <div className="h-4 w-6 bg-bg-tertiary rounded animate-pulse" />
            ...
            <div className="h-4 w-20 bg-bg-tertiary rounded animate-pulse ml-auto" />
